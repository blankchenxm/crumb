...
const char * LIB_PATH_VALUE   = "D:\\Projects\\Button\\Software\\ESP-IDF\\crumb_v1\\rnnoise\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\Projects\\Button\\Software\\ESP-IDF\\crumb_v1\\rnnoise\\.libs;D:\\msys64\\ucrt64\\lib;D:\\msys64\\ucrt64\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/d/Projects/Button/Software/ESP-IDF/crumb_v1/rnnoise/.libs:/ucrt64/lib", f);
  fputs (":/ucrt64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/Projects/Button/Software/ESP-IDF/crumb_v1/rnnoise/.libs:$PATH\"\n", f);
  fputs ("\n", f);
