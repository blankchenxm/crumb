...
// HTTPS to the tunnel needs ESP32 TLS to negotiate with Cloudflare (finicky);
// using plain HTTP on Cloudflare's port 80 (disable "Always Use HTTPS") instead.
// #define SERVER_URL              "https://crumb.xiaomeng-research.xyz/upload"
#define SERVER_URL              "http://crumb.xiaomeng-research.xyz/upload"
